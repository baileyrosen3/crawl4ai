# Source: https://docs.crawl4ai.com/core/link-media
...
> **Prerequisites**  
>  - You have completed or are familiar with the [AsyncWebCrawler Basics](https://docs.crawl4ai.com/simple-crawling/) tutorial.  
